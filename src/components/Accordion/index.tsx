...
const Accordion: React.FC<Props> = ({ children, header, props, onExpanded, SubHeader,
    maxHeight = "",overflow ="" ,bgcolor,color,boxRadius}) => {
    let SubHeader1 = (SubHeader ? 'panel1' : false);
    const [expanded, setExpanded] = useState<string | false>(onExpanded === true ? SubHeader1 : 'panel1');
